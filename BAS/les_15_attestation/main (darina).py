...
def dijkstra(edges, num_nodes, start):
    ...
    # Вспомогательная функция для восстановления пути до вершины
 
 
    # Возвращаем список минимальных расстояний и восстановленные пути до каждой вершины.
...
def find_shortest_paths(graph, routes):
    shortest_paths = {}
...
result = find_shortest_paths(graph, routes)
